#!/usr/bin/env python3
"""
Generate a clear flowchart for AXI4 Scoreboard Report Phase
Creates both SVG and HTML versions
"""

def create_scoreboard_flowchart():
    """Create a clear flowchart for the scoreboard report phase"""
...
"""
    ...
    # Save SVG file
    with open("scoreboard_report_flowchart.svg", "w") as f:
        f.write(svg_content)
...
"""
    ...
    with open("scoreboard_report_flowchart.html", "w") as f:
        f.write(html_content)
    
    print("✅ Generated scoreboard flowchart files:")
    print("   - scoreboard_report_flowchart.svg")
    print("   - scoreboard_report_flowchart.html")

if __name__ == "__main__":
    create_scoreboard_flowchart()