...
extern "C" {
#endif
void  rmaPropagate0_p_simv_new_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_simv_new_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_simv_new_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate0_r_simv_new_daidir (UB  * pcode);
void  rmaPropagate0_t0_simv_new_daidir (UB  * pcode, UB  val);
void  rmaPropagate0_wn_simv_new_daidir (UB  * pcode, scalar  val);
